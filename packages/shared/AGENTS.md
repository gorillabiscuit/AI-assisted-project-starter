# packages/shared — package-specific AGENTS.md

Inherits everything from the root `AGENTS.md` (`CLAUDE.md` is a symlink to it). This file holds rules that apply ONLY to `packages/shared`.
...
- All non-trivial logic uses Approach B (sub-agent isolation) per AGENTS.md §8.1.
