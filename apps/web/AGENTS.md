# apps/web — package-specific AGENTS.md

Inherits everything from the root `AGENTS.md` (`CLAUDE.md` is a symlink to it). This file holds rules that apply ONLY to the web app.
...
_Refine this file as the web app's patterns settle. When in doubt, default to root `AGENTS.md` rules._
